              ...
              <div className="illust" style={{ overflow: 'hidden', borderRadius: '8px', justifyContent: 'flex-end' }}>
                <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
                  <svg viewBox="0 0 220 160" width="100%" style={{ display: 'block' }}>
                    {[
                      { label: '진보·보수', w: 129, pct: '92.4%', delay: '1.0s' },
                      { label: '부유·서민', w: 108, pct: '77.3%', delay: '1.12s' },
                      { label: '기성·청년', w: 101, pct: '71.8%', delay: '1.24s' },
                      { label: '수도·지방', w: 97, pct: '69.5%', delay: '1.36s' },
                      { label: '남성·여성', w: 85, pct: '61.0%', delay: '1.48s' },
                    ].map((d, i) => {
                      const y = 9 + i * 26
                      return (
                        <g className="bar-row" style={{ '--delay': d.delay }} key={i}>
                          <text x="0" y={y + 9} fontFamily="'Noto Sans KR',sans-serif" fontSize="9" fill="#a09888">{d.label}</text>
                          <rect x="58" y={y} width="140" height="12" rx="3" fill="rgba(201,168,76,0.08)" />
                          <rect x="58" y={y} width={d.w} height="12" rx="3" fill={`rgba(201,168,76,${0.45 - i * 0.06})`} />
                          <text x="196" y={y + 9} fontFamily="Cinzel,serif" fontSize="9" fill="#c9a84c">{d.pct}</text>
                        </g>
                      )
                    })}
                  </svg>
                ...
                <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
                  <svg viewBox="0 0 220 175" width="100%" style={{ display: 'block' }}>
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 2.2s' }}>
                      <path d="M110,15 A60,60 0 0,1 163.7,99.5 L110,75 Z" fill="rgba(217,64,64,0.7)" stroke="var(--bg)" strokeWidth="1.5" />
                    ...
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 2.4s' }}>
                      <path d="M163.7,99.5 A60,60 0 0,1 103.3,134.6 L110,75 Z" fill="rgba(232,190,40,0.7)" stroke="var(--bg)" strokeWidth="1.5" />
                    ...
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 2.6s' }}>
                      <path d="M103.3,134.6 A60,60 0 0,1 56.3,99.5 L110,75 Z" fill="rgba(80,120,200,0.65)" stroke="var(--bg)" strokeWidth="1.5" />
                    ...
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 2.8s' }}>
                      <path d="M56.3,99.5 A60,60 0 0,1 54.2,52.9 L110,75 Z" fill="rgba(120,120,120,0.6)" stroke="var(--bg)" strokeWidth="1.5" />
                    ...
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 2.9s' }}>
                      <path d="M54.2,52.9 A60,60 0 0,1 110,15 L110,75 Z" fill="rgba(120,120,120,0.25)" stroke="var(--bg)" strokeWidth="1.5" />
                    </g>
                    ...
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 3.2s' }}>
                      <circle cx="70" cy="148" r="4" fill="rgba(217,64,64,0.7)" /><text x="78" y="151" fontFamily="'Noto Sans KR',sans-serif" fontSize="7" fill="#a09888">분노 27%</text>
                      <circle cx="120" cy="148" r="4" fill="rgba(232,190,40,0.7)" /><text x="128" y="151" fontFamily="'Noto Sans KR',sans-serif" fontSize="7" fill="#a09888">혐오 22%</text>
                    </g>
                    <g style={{ opacity: 0, animation: 'fade-in 0.5s ease forwards 3.4s' }}>
                      <circle cx="70" cy="162" r="4" fill="rgba(80,120,200,0.65)" /><text x="78" y="165" fontFamily="'Noto Sans KR',sans-serif" fontSize="7" fill="#a09888">슬픔 16%</text>
                      <circle cx="120" cy="162" r="4" fill="rgba(120,120,120,0.6)" /><text x="128" y="165" fontFamily="'Noto Sans KR',sans-serif" fontSize="7" fill="#a09888">부정 16%</text>
                    </g>
                  </svg>
                </div>
              </div>
            ...
            <div className="card-graphic">
              <div className="illust">
                <svg viewBox="0 0 160 110" width="100%" height="100%">
                  <circle cx="45" cy="55" r="16" fill="none" stroke="rgba(201,168,76,0.35)" strokeWidth="1.5" />
                  <circle cx="45" cy="50" r="6" fill="rgba(201,168,76,0.25)" />
                  <path d="M35,62 Q45,70 55,62" stroke="rgba(201,168,76,0.25)" strokeWidth="1.5" fill="none" />
                  <circle cx="115" cy="55" r="16" fill="none" stroke="rgba(139,46,46,0.35)" strokeWidth="1.5" />
                  <circle cx="115" cy="50" r="6" fill="rgba(139,46,46,0.25)" />
                  <path d="M105,62 Q115,70 125,62" stroke="rgba(139,46,46,0.25)" strokeWidth="1.5" fill="none" />
                  <line x1="62" y1="52" x2="98" y2="52" stroke="rgba(201,168,76,0.25)" strokeWidth="1.5" strokeDasharray="4 3">
                    <animate attributeName="stroke-dashoffset" values="0;-14" dur="2s" repeatCount="indefinite" />
                  </line>
                  <line x1="98" y1="58" x2="62" y2="58" stroke="rgba(139,46,46,0.25)" strokeWidth="1.5" strokeDasharray="4 3">
                    <animate attributeName="stroke-dashoffset" values="0;-14" dur="2s" repeatCount="indefinite" />
                  </line>
                </svg>
              </div>
