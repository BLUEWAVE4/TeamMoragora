...
const items = [
  ...
  { num: '03', title: '해결 전략', page: '5p', dataI: '05' },
  { num: '04', title: '서비스 구조', page: '6p', dataI: '06' },
  { num: '05', title: '핵심 기능 시연', page: '7p', dataI: '07' },
  { num: '06', title: '차별점 & 기술 스택', page: '8p', dataI: '08' },
  { num: '07', title: '기대효과 및 활용방안', page: '9p', dataI: '09' },
  { num: '08', title: '팀 소개', page: '10p', dataI: '10' },
]
