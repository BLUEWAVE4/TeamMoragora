...
import S7bCoreTech from './components/slides/S7bCoreTech'
import S8bTrouble from './components/slides/S8bTrouble'
...
const SLIDES = [
  S1Title, S2Toc,
  /* WHY */ S3Proposal, S3bProblem, S4bNeed,
  /* HOW */ S5Strategy, S6Structure, S7Demo, S7bCoreTech, S8bTrouble,
  /* WHAT */ S8TechStack, S9Effects, S10Team, S11Closing,
]
