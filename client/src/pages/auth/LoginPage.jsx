...
const handleGoogleLogin = () => {
  if (isKakaoTalk && isAndroid) {
    ...
    alert("아이폰 카카오톡 내에서는 구글 로그인이 차단될 수 있습니다. 외부 브라우저로 열어주세요.");
  } else {
    signInWithGoogle();
  }
};
        ...
        <div className="w-full max-w-[320px] flex flex-col gap-4">
          ...
          {!isKakaoOnly && (
            <button
              ...
              px-4 py-4 font-bold text-white/70 active:scale-[0.97] transition-all w-full shadow-lg shadow-black/20 hover:bg-white/12 cursor-pointer">
