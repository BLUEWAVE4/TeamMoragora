...
export const AI_JUDGES = {
  gpt: {
    ...
    avatarActive: `${gptBase}&eyes=squint&eyebrows=raisedExcitedNatural&mouth=serious`,
    avatarDone: `${gptBase}&eyes=happy&eyebrows=defaultNatural&mouth=smile`,
  ...
  gemini: {
    ...
    avatarActive: `${geminiBase}&eyes=side&eyebrows=upDown&mouth=serious`,
  ...
  claude: {
    ...
    avatarActive: `${claudeBase}&eyes=surprised&eyebrows=upDownNatural&mouth=serious`,
