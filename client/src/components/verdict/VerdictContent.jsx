      ...
      {(argA || argB || isChat) && (
        <div className="bg-gradient-to-b from-surface to-surface-alt rounded-2xl shadow-sm border border-gold/10 overflow-hidden">
          <div className="flex items-center gap-2 p-4 pb-0">
            ...
            {isChat && <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-50 text-blue-500 font-bold border border-blue-100">채팅 논쟁</span>}
          </div>
                      ...
                      <div className={`flex-1 min-w-0 ${isMine ? 'text-right' : ''}`}>
                        ...
                        <div className={`flex items-end gap-1.5 mt-1 ${isMine ? 'flex-row-reverse' : ''}`}>
                          ...
                          >
                            ...
                            {c.likes_count > 0 && <span className="text-[9px] text-[#1B2A4A]/30 -mt-0.5">{c.likes_count}</span>}
                          </button>
                          {c._confirmDelete && (
