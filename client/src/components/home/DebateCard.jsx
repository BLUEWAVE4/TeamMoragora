                      ...
                      return (
                        <div key={c.id} className={`flex gap-2.5 ${isMine ? 'flex-row-reverse' : ''}`}>
                          ...
                          <div className={`flex-1 min-w-0 ${isMine ? 'text-right' : ''}`}>
                            ...
                            <div className={`flex items-end gap-2 mt-1 ${isMine ? 'flex-row-reverse' : ''}`}>
                              ...
                              <div className="flex items-center gap-1 shrink-0 pb-0.5">
                                ...
                                >
                                  <svg width="14" height="14" viewBox="0 0 24 24" fill={c._liked ? '#E63946' : 'none'} stroke={c._liked ? '#E63946' : '#1B2A4A'} strokeWidth="2" opacity={c._liked ? 1 : 0.25}>
                                ...
                                {isMine && (
                                  ...
                                  >
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1B2A4A" strokeWidth="2" opacity="0.25">
