...
// const Card = ({ children, title, subtitle, variant = 'base', className = '' }) => {
//   const baseStyles = "overflow-hidden rounded-2xl border border-gold/10 transition-all duration-500 shadow-md hover:shadow-2xl hover:-translate-y-2 group";
