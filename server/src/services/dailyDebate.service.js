...
pro_side/con_side 작성 규칙 (매우 중요):
- 반드시 "~다", "~한다" 형태의 완결된 문장으로 작성
- 누구든 읽자마자 A/B 중 하나를 고를 수 있도록 명확한 입장 표현
- 나쁜 예: "관심 표현 최소한", "SNS 강요 부담" (모호하고 입장이 불명확)
- 좋은 예: "안 봐도 상관없다", "안 보면 서운하다" (즉시 선택 가능)
- 15자 이내, 주제와 직접 연결되는 입장
...
반드시 아래 JSON 형식으로만 응답하세요:
{
  ...
  "pro_side": "찬성 측 입장 (15자 이내, 완결된 문장)",
  "con_side": "반대 측 입장 (15자 이내, 완결된 문장)"
}`,
      },
    ],
  });
