...
|:---:|:---:|:---:|
| <img src="client/dist/capture01.png" width="250" /> | <img src="client/dist/capture02.png" width="250" /> | <img src="client/dist/capture03.png" width="250" /> |
...
`client/.env`와 `server/.env`를 각각 설정해야 합니다.
...
| 이름 | 역할 | 담당 |
|------|------|------|
| 김선관 | Backend | Express + AI 판결 + 콘텐츠 필터링 + Socket.IO |
